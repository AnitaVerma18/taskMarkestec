...
const products = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield Service.products(req);
...
const addCart = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield Service.addCart(req);
        return Handler.handleSuccess(res, response);
    }
    catch (err) {
        return Handler.handleCatchError(res, err);
...
const removeCart = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield Service.removeCart(req);
        return Handler.handleSuccess(res, response);
    }
    catch (err) {
        return Handler.handleCatchError(res, err);
...
const cartList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield Service.cartList(req);
        return Handler.handleSuccess(res, response);
    }
    catch (err) {
        return Handler.handleCatchError(res, err);
