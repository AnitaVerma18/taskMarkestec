...
exports.fetchUser = exports.verifyToken = exports.signToken = exports.generateUniqueCode = exports.comparePassword = exports.hashPassword = exports.setOptions = void 0;
...
const verifyToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if ((err === null || err === void 0 ? void 0 : err.message) == "jwt expired") {
            yield Models.Sessions.deleteOne({ accessToken: token });
...
const checkSessionData = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield Models.Sessions.findOne(query, projection, option);
        return response;
    }
    catch (err) {
        return Handler.handleCustomError(err);
...
const fetchUser = (query) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = yield Models.Users.findOne(query, projection, option);
        return data;
    }
    catch (err) {
        return Handler.handleCustomError(err);
